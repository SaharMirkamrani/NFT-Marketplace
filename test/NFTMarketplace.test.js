...
const { developmentChains } = require("../config/networks");
...
!developmentChains.includes(network.name)
  ...
  : describe("Nft Marketplace Unit Tests", function () {
      ...
      beforeEach(async () => {
        ...
        let marketplaceAddress = nftMarketplace.address

        basicNftContract = await ethers.getContractFactory("SimpleNFT");
        basicNft = await basicNftContract.deploy();
        basicNft.deployed();
        await basicNft.mint({value: ethers.utils.parseEther("0.001")});
